...
def gen_img_dict():
    ...
    for i, seq in enumerate(seqs):
        ...
        # print(seq_name, seq)
        gt_path = gt_dir + '090303_' + seq_name + '_all.txt'
        img_cell_dict = load_img(seq, gt_path, img_cell_dict, seq_name)

    print(img_cell_dict.keys())
    np.save('/home/hzhang/zhanghaishan/docs/GraphQP/data/090303/img_cell_dict_test-1.npy', img_cell_dict)
